---
#preview details
title: "Mobilya ve Dekor"
icon: "/img/icons/5.svg"
short: "Mekânı tamamlayan mobilya ve dekorasyon çözümleri sunarız."
...
description:
  - layout: 1
    title: Açıklama
    content:
      <p>Mobilya ve dekorasyon, mekânın kimliğini güçlendirir ve kullanım deneyimini zenginleştirir. Malzeme, doku ve renk uyumu bütüncül bir yaklaşımla ele alınır.</p>
      <p>Doğru seçimler, hem estetik hem de fonksiyonel bir bütünlük oluşturur.</p>
    divider: true

  - layout: 2
    title: Faydalar
    content:
      <p>Doğru mobilya seçimi, mekânın işlevini güçlendirir ve konforu artırır.</p>
      <p>Dekorasyon dokunuşları, markanın veya yaşam tarzının karakterini yansıtır.</p>
    list:
      - 3D Modelleme
