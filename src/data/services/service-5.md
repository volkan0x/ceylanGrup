---
#preview details
title: "Dış Cephe Tasarımı"
icon: "/img/icons/3.svg"
short: "Yapının kimliğini yansıtan güçlü ve dayanıklı dış cephe çözümleri sunarız."
...
description:
  - layout: 1
    title: Açıklama
    content:
      <p>Dış cephe tasarımı, yapının ilk izlenimini belirler ve uzun ömürlülüğünü destekler. Malzeme seçimi, iklim koşullarına uygun performans kriterleriyle yapılır.</p>
      <p>Estetik, enerji verimliliği ve bakım kolaylığı birlikte değerlendirilir. Bu sayede hem görsel hem de teknik açıdan güçlü cepheler oluşturulur.</p>
    divider: true

  - layout: 2
    title: Faydalar
    content:
      <p>Doğru cephe sistemi, enerji tasarrufu sağlar ve yapının değerini artırır.</p>
      <p>Dayanıklı malzemelerle bakım maliyetleri düşer.</p>
    list:
      - 3D Modelleme
