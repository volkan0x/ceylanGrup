...
short: "İç mekânları işlev, konfor ve estetik dengesinde yeniden kurgularız."
...
description:
  - layout: 1
    title: Açıklama
    content:
      <p>İç mekân dekorasyonu, kullanıcı ihtiyaçlarını doğru analiz eden planlama ile başlar. Malzeme, renk ve aydınlatma seçimleri birlikte ele alınarak mekânın kimliği oluşturulur.</p>
      <p>Detaylara gösterilen özen, mekânın uzun ömürlü ve sürdürülebilir olmasını sağlar. Fonksiyonel depolama çözümleri ve ergonomik yerleşim, kullanım konforunu artırır.</p>
    divider: true

  - layout: 2
    title: Faydalar
    content:
      <p>Mekân tasarımlarımız yaşam kalitesini yükseltir. Kullanıcı odaklı çözümlerle konut ve ticari alanlarda verimli, şık ve dengeli tasarımlar üretiriz.</p>
      <p>Her proje, bütçe ve zaman planına uygun şekilde yönetilir.</p>
    list:
      - 3D Modelleme
