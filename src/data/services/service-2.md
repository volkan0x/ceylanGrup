...
short: "Mekânın ihtiyaçlarını analiz ederek işlevsel ve estetik planlar oluştururuz."
...
description:
  - layout: 1
    title: Açıklama
    content:
      <p>Tasarım ve planlama süreci, hedeflerin netleştirilmesi ve doğru stratejinin kurulmasıyla başlar. Mekânsal veriler, kullanıcı alışkanlıkları ve teknik gereksinimler birlikte değerlendirilir.</p>
      <p>Böylece hem estetik hem de işlevsel çözümler elde edilir. Uygulama sırasında maliyet ve zaman planı kontrollü şekilde yönetilir.</p>
    divider: true

  - layout: 2
    title: Faydalar
    content:
      <p>Planlı bir süreç, proje risklerini azaltır ve kararları hızlandırır. İyi kurgulanmış tasarım, yatırımın geri dönüşünü artırır.</p>
      <p>Tüm adımlar ölçülebilir hedeflerle ilerletilir.</p>
    list:
      - 3D Modelleme
