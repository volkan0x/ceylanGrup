---
#preview details
title: "Konut Konsepti"
icon: "/img/icons/4.svg"
short: "Konut projelerinde yaşam konforunu artıran konseptler geliştiririz."
...
description:
  - layout: 1
    title: Açıklama
    content:
      <p>Konut konsepti, yaşam alışkanlıklarını merkeze alarak mekânın karakterini belirler. Fonksiyon, estetik ve konfor dengesi birlikte tasarlanır.</p>
      <p>Bu yaklaşım, hem günlük yaşamda kullanım kolaylığı sağlar hem de uzun vadede değer üreten yaşam alanları oluşturur.</p>
    divider: true

  - layout: 2
    title: Faydalar
    content:
      <p>Konut projelerinde doğru konsept, kullanıcı memnuniyetini ve satış değerini artırır.</p>
      <p>İhtiyaca uygun planlama ile mekânlar daha verimli kullanılır.</p>
    list:
      - 3D Modelleme
